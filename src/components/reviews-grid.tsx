        ...
        <PaginationContent>
          <PaginationItem>
            <PaginationPrevious
              ...
              className={cn(currentPage > 1 ? "opacity-100" : "opacity-50 pointer-events-none")} size={undefined}            />
          </PaginationItem>
          ...
          <PaginationItem>
            <PaginationNext
              ...
              className={cn(currentPage < totalPages ? "opacity-100" : "opacity-50 pointer-events-none")} size={undefined}            />
          </PaginationItem>
        </PaginationContent>
      </Pagination>
    </div>
